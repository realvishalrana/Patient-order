      ...
      <div className="border-b pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-900 capitalize">{data.gender.label}</p>
          </div>
        </div>
      </div>
              ...
              <div key={index} className="bg-gray-50 p-4 rounded-lg">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-gray-900">{labOrder.name.label}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">
                      Specimen
                ...
                {labOrder.instruction && (
                  <div className="mt-4">
                    ...
                    <p className="mt-1 text-gray-900">{labOrder.instruction}</p>
                  </div>
                )}
              </div>
            ))}
              ...
              <div key={index} className="bg-gray-50 p-4 rounded-lg">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-900">{medicine.qty}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">
                      Total Price
